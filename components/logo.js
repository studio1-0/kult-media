  ...
  <Fragment>
    <svg width="128" height="120" viewBox="0 0 128 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="Logo_base">
            ...
            <g id="Group 9.1">
                <ellipse id="Ellipse 2.5" cx="110.549" cy="20.4108" rx="14.2717" ry="14.4756" fill="#B586FB" fillOpacity="0.1"/>
                <ellipse id="Ellipse 2.3" cx="112.588" cy="16.7408" rx="14.2717" ry="14.4756" fill="#B586FB"/>
                <circle id="Ellipse 2.4" cx="117.481" cy="13.2749" r="5.70867" fill="#C886FB"/>
            ...
            <g id="Group 10.1">
                <path id="Rectangle 2" d="M10.5005 61.1643L43.3481 69.9658L1.699 94.0119L10.5005 61.1643Z" fill="#FEE333" fillOpacity="0.1"/>
                <path id="Rectangle 2.1" d="M13.592 64.2558L46.4397 73.0573L4.79055 97.1034L13.592 64.2558Z" fill="#FEE333"/>
            ...
            <g id="Group 11.1">
                <rect id="Rectangle 2_2" x="68.5267" y="106.56" width="62.4737" height="10.7231" transform="rotate(-30 68.5267 106.56)" fill="#FD7FD4" fillOpacity="0.1"/>
                <rect id="Rectangle 2.2" x="68.5267" y="110.289" width="62.4737" height="10.7231" transform="rotate(-30 68.5267 110.289)" fill="#FD7FD4"/>
            ...
            <g id="Group 12.2">
                <rect id="Rectangle 2_3" x="4.86646" y="11.037" width="27.8147" height="27.8147" transform="rotate(-15 4.86646 11.037)" fill="#0D38FB" fillOpacity="0.1"/>
                <rect id="Rectangle 2.1_2" y="8.22736" width="27.8147" height="27.8147" transform="rotate(-15 0 8.22736)" fill="#0D38FB"/>
